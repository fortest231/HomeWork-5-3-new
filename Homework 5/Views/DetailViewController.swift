...
//  Homework 5
//
//  Created by Руслан Канжарбеков on 27.01.2024.
//
...
class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dataSource = [
            UserCard(avatarImage: UIImage(named: "avatar1"), notificationText: "Jane Cooper has published a new recipe!", timestampText: "Today | 09:24 AM", productImage: UIImage(named: "Image")),
            UserCard(avatarImage: UIImage(named: "avatar2"), notificationText: "Rochel has commented on your recipe", timestampText: "1 day ago | 14:43 PM", productImage: UIImage(named: "Image (1)")),
            UserCard(avatarImage: UIImage(named: "avatar3"), notificationText: "Brad Wigington liked your comment", timestampText: "1 day ago | 09:29 AM", productImage: UIImage(named: "Image (2)")),
            UserCard(avatarImage: UIImage(named: "avatar4"), notificationText: "Tyra Ballentine has published a new recipe!", timestampText: "2 days ago | 10:29 AM", productImage: UIImage(named: "Image (3)")),
            UserCard(avatarImage: UIImage(named: "avatar5"), notificationText: "Marci Winkles has published a new recipe!", timestampText: "3 days ago | 16:52 PM", productImage: UIImage(named: "Image (4)")),
            UserCard(avatarImage: UIImage(named: "avatar6"), notificationText: "Aileen has commented on your recipe", timestampText: "4 days ago | 14:27 PM", productImage: UIImage(named: "Image (5)")),
            UserCard(avatarImage: UIImage(named: "avatar7"), notificationText: "George has commented on your recipe", timestampText: "5 days ago | 09:20 AM", productImage: UIImage(named: "Image (6)"))
        ]
